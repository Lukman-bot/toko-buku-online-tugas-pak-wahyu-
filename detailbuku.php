<html>
    ...
    <body>
        ...
        <?php
            ...
            if ($result) {
                list($buku_isbn, $buku_judul, $pengarang_nama, $penerbit_nama, $buku_harga, $buku_tglterbit, $buku_jmlhalaman, $buku_deskripsi) = mysqli_fetch_array($result);
                ?>
                <table class="buku">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="490" align="left">
                            <strong><?php echo $tglterbit; ?></strong>
                        </td>
                    </tr>
                    <tr>
